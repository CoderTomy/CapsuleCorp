...
namespace CapsuleCorp.Controllers
{
    public class PacienteController : Controller
    {
        ...
        public PacienteController(CapsuleCorpDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("pacienteID,DNI,nombre,apellido,mail,contrasenia")] Paciente paciente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("pacienteID,DNI,nombre,apellido,mail,contrasenia")] Paciente paciente)
        {
